...
endQuestMoveToCastle = function()
	...
	checkLocation("villageattack_save_village")
...
startQuestSearchMayor1 = function()
	...
	checkLocation("villageattack_camps_cleared")
...
startQuestErecsArrival = function()
	...
	checkLocation("villageattack_erec_arrival")
...
endQuestErecsArrival = function()
	...
	checkLocation("villageattack_victory")
...
--				Logic.SetTechnologyState(GetHumanPlayer(),Technologies.GT_GearWheel, 3)	
				...
				checkLocation("villageattack_speak_with_leonardo")
