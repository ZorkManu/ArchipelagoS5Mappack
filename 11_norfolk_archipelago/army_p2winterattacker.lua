...
--Report ("BuildUpWinterAttacker")
	...
	initArmyP2WinterAttacker(ArmyP2WinterAttacker1, "ArmyP2WinterAttacker1", 6, "pos1", 3000)
	initArmyP2WinterAttacker(ArmyP2WinterAttacker2, "ArmyP2WinterAttacker2", 7, "pos2", 3000)
	initArmyP2WinterAttacker(ArmyP2WinterAttacker3, "ArmyP2WinterAttacker3", 8, "pos3", 3000)
...
SetupArmyP2WinterGather = function(_army)
	...
	_army.strength = math.min(8, 4 + getArchipelagoDifficultyMultiplier())
