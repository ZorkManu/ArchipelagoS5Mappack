createPlayer4 = function()
	...
	local aiDescription = {
		...
		--------------------------------------------------
		refresh = {
			gold				=	30 + getArchipelagoDifficultyMultiplier() * 30,
			clay				=	10 + getArchipelagoDifficultyMultiplier() * 30,
			iron				=	5 + getArchipelagoDifficultyMultiplier() * 30,
			sulfur				=	10 + getArchipelagoDifficultyMultiplier() * 30,
			stone				=	10 + getArchipelagoDifficultyMultiplier() * 30,
			wood				=	10 + getArchipelagoDifficultyMultiplier() * 30,
			updateTime			=	10
		},
		--------------------------------------------------
		extracting = false,
