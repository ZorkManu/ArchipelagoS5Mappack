setupArmyP4Attacker = function()
	...
	ArmyP4Attacker.id					= 	3
	ArmyP4Attacker.strength				= 	math.min(8, 4 + getArchipelagoDifficultyMultiplier())
	...
	TimeLine.Enter("Start P4 Attack", TimeLine.Seconds + 600 - getArchipelagoDifficultyMultiplier() * 60, "StartArmyP4Attacker")
end
