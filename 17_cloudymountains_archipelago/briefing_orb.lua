createBriefingOrb = function()
	...
	briefingOrb.finished = briefingOrbFinished
		...
		Logic.SetTechnologyState(gvMission.PlayerID, Technologies.T_ChangeWeather, 3)
		Logic.SetTechnologyState(gvMission.PlayerID, Technologies.T_WeatherForecast, 3)
