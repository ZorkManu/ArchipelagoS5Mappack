...
function Mission_InitPlayerColorMapping()
	...
	Display.SetPlayerColorMapping(3, 3)		-- Leonardo
	...
	Display.SetPlayerColorMapping(6, 4)		-- Tendrel
...
function isDeadKerberos()
	if GlobalMissionScripting.IsEntityDestroyed("KerberosDefenseOP") then
		checkLocation("evelance_destroy_kerberos")
		return true
	end
end
