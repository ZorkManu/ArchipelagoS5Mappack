...
createArmyVillageRaiders = function()
	...
	--	create army	a
		...
		troopDescription.maxNumberOfSoldiers = math.min(4, getArchipelagoDifficultyMultiplier())
...
--		troopDescription.leaderType = Entities.PU_LeaderPoleArm1
	...
	--	create army	b
		...
		troopDescription.maxNumberOfSoldiers = math.min(4, getArchipelagoDifficultyMultiplier()-1)
