...
function Cutscene_Cutscene3_Start()
	 ...
	 CreateEntity(8, Entities.CU_BanditLeaderSword2, GetPosition("CutsceneCutscene3AriLeader1"), "Cutscene3AriLeader1" ) 
	 CreateEntity(8, Entities.CU_BanditLeaderSword2, GetPosition("CutsceneCutscene3AriLeader2"), "Cutscene3AriLeader2" ) 
	 CreateEntity(8, Entities.CU_BanditLeaderSword2, GetPosition("CutsceneCutscene3AriLeader3"), "Cutscene3AriLeader3" ) 
	 CreateEntity(8, Entities.CU_BanditLeaderSword2, GetPosition("CutsceneCutscene3AriLeader4"), "Cutscene3AriLeader4" ) 
	 CreateEntity(8, Entities.CU_BanditLeaderSword2, GetPosition("CutsceneCutscene3AriLeader5"), "Cutscene3AriLeader5" ) 
