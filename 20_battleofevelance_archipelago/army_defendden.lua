...
createArmyDefendDen = function()
	...
	-- 	before gate in front of castle
		...
		armyDefendInnerCircle.player 					= 5
		armyDefendInnerCircle.id						= 2
	...
	--	knights patrol along defend positions
		...
		armyDefendPatrol.player 			= 5
		armyDefendPatrol.id					= 6
