...
createBriefingReinforcementArrives2 = function()
	...
	--	page
		...
		briefingReinforcementArrives2[page].title		= 	String.GenericKey("Mentor")
		briefingReinforcementArrives2[page].text		=	String.Key("briefingReinforcementArrives[1].text")
