...
--	ResolveBriefing(briefingPrelude[3])
	...
	checkLocation("wasteland_winter")
...
end3rdQuest = function()	
	...
	checkLocation("wasteland_village_rain")
...
end4thQuest = function()	
	...
	checkLocation("wasteland_soldiers_rescue")
...
end5thQuest = function()	
	...
	checkLocation("wasteland_village_build_residences")
...
-------------------------------------------------------------------------------------------------------------------------
--
--									6th Quest:	Search Allies (alle 4 D�rfer befreien)
--
-------------------------------------------------------------------------------------------------------------------------
...
VillageDone = function()
	...
	if VillageDoneCount == 4 then
		...
		end6thQuest()	
		checkLocation("wasteland_victory")
...
end1stSubQuest = function()
	...
	checkLocation("wasteland_village_weathermaster")
