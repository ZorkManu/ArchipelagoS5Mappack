...
function Mission_InitPlayerColorMapping()
	...
	-- set player colors
		...
		Display.SetPlayerColorMapping(gvMission.PlayerIDFolklung, EVIL_GOVERNOR_COLOR)		
		Display.SetPlayerColorMapping(gvMission.PlayerIDBesieger, NEPHILIM_COLOR)		
		Display.SetPlayerColorMapping(gvMission.PlayerIDBigBadGuy, ENEMY_COLOR1)		
